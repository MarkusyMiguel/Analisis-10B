//ejemplo
//Cree un algoritmo con ciclo for que se itere 100 veces, si el usuario escribe la palabra Hola debe detener el ciclo.
for(var i=0; i<100; i+=1){
    palabra=prompt("Ingrese Hola");
    if(palabra=="Hola"){
        break;
    }  
}

//Algoritmo que imprime los números del 1 al 10
for(var i=1; i<=10; i+=1){//el incremento de i+=1, se puede escribir también como i++
    console.log(i);
}

//Algoritmo que imprime los números del 10 al 1
for(var i=10; i>=1; i--){//el decremento de i--, se puede escribir también como i-=1
    console.log(i);
}

//Algoritmo que solicite un número, muestre la sumatoria desde 1 hasta el número recibido.
...
//Algoritmo que solicite dos números (inicio y fin) y muestre los números pares.
...
//Cree un ciclo for que guarde 5 nombres de estudiantes en un vector/arreglo.
